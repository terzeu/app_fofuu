...
export class RegistraMercadoriaScreen extends Component {
  ...
  onSuccess = async (e) => {
    ...
    if (!token) return;
    let body = {tag:base64.encode(e.data), modo:"registrar", gps:gps, data: new Date()}
    ...
    let result;
      try {
        ...
        mensagem = "não foi possível registra a mercadoria, tente novamente mais tarde";
        bgColor = "danger";
        console.log(err);
      }
