...
class AtividadesScreen extends Component {
    ...
    return (
      <View style={{flex:1}}>
        ...
        <ScrollView style={styles.container}>
          ...
          <List>
            <ListItem onPress={()=>{navigation.navigate("Concluir")}} noIndent style={{padding:10, backgroundColor:"white", marginBottom:10}}>
...
export default connect(mapStateToProps)(AtividadesScreen);
 
// AppRegistry.registerComponent('AtividadesScreen', () => AtividadesScreen);
 
// module.exports = AtividadesScreen;